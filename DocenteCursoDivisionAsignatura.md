select  DISTINCT CL.nombre as 'Ciclo Lectivo',pe.username,N.nombre as 'Curso', C.nombre as 'Division', A.nombre as 'Asignatura', PE.apellido as 'Apellido Docente', PE.nombre as 'Nombre Docente',PE.idpersona, ACL.idasignaturaciclolectivo
