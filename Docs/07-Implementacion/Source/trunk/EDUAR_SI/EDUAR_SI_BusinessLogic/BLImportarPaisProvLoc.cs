...
{
	public class BLImportarPaisProvLoc : BLProcesoBase
	{
		#region --[Atributos]--
		...
		public BLImportarPaisProvLoc(String connectionString)
		...
		public void ImportarPaisProvinciaLocalidad()
		{
			try
			{
				...
				ProcesosEjecutadosCreate(enumProcesosAutomaticos.ImportarPaisProvinciaLocalidad.GetHashCode(), true);
			}
			catch (Exception ex)
			{
				...
				OnErrorProcess(enumProcesosAutomaticos.ImportarPaisProvinciaLocalidad.GetHashCode(), ex);
				throw ex;
			}
		}
		#endregion
