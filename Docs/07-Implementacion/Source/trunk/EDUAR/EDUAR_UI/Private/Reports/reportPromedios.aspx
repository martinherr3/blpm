...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Reporte consolidado por período</h2>
    <br/>
	    ...
	    <table class="tablaInterna" width="100%">
		    <tr>
			    ...
			    <td rowspan="3" class="TDCriterios75">
				    <asp:RadioButtonList ID="rdlAccion" runat="server" OnSelectedIndexChanged="rdlAccion_OnSelectedIndexChanged" AutoPostBack="true">
    ...
    <div id="divFiltrosIncidencia" runat="server">
        <table class="tablaInterna" cellpadding="0" cellspacing="0">
            <tr>
                <td align="right">
                    <asp:ImageButton ID="btnBuscarIncidencia" OnClick="btnBuscar_Click" runat="server" ToolTip="Buscar"
                        ImageUrl="~/Images/botonBuscar.png" />
                </td>
            </tr>
        </table>
        ...
        <table class="tablaInterna" cellpadding="1" cellspacing="5">       
            <tr>
                ...
                <td valign="top" class="TDCriterios25">
                    <asp:DropDownList ID="ddlCurso2" runat="server" onselectedindexchanged="ddlCurso_SelectedIndexChanged" AutoPostBack="True">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
