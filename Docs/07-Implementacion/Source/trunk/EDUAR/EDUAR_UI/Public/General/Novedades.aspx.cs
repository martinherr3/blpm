...
namespace EDUAR_UI
{
    ...
    public partial class Novedades : EDUARBasePage
    {
        ...
        private void CargarNovedades()
        {
            ...
            {
                udpNovedades.ContentTemplateContainer.Controls.Add(new LiteralControl("<h3>" + evento.descripcionBreve.ToUpper() + " - <small>" + evento.fecha.ToShortDateString() + "</small></h3>"));
