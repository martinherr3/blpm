...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="tablaInterna" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <h2>Indicadores Generales de Desempeño -
        ...
        <tr>
            <td valign="top" colspan="2" align="center" style="width: 100%">
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <table class="tablaInternaSinBorde" cellpadding="1" cellspacing="5" style="text-align: justify; width: 100%">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <cri:Criterio ID="criterioSancion" runat="server" nombreCriterio="Sanciones" esMaximzante="false"></cri:Criterio>
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
