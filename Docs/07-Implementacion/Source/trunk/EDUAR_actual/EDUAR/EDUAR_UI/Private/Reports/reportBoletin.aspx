<%@ Page Title="Informe consolidado" Language="C#" MasterPageFile="~/EDUARMaster.Master"
    AutoEventWireup="true" CodeBehind="reportBoletin.aspx.cs" Inherits="EDUAR_UI.reportBoletin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Boletín de Desempeño Académico</h2>
    <br />
    <div id="divAccion" runat="server">
        <table class="tablaInterna" cellpadding="0" cellspacing="0">
            <tr>
                <td align="left">
                   <%-- <asp:Label ID="lblTutor" runat="server" Text="Tutor:" CssClass="lblTutor"></asp:Label>--%>
                </td>
            ...
            <tr>
                <td align="left">
                <%-- <asp:Label ID="lblAlumnos" runat="server" Text="Alumno(s):" CssClass="lblAlumnos"></asp:Label>--%>
    ...
    <div id="divFiltros" runat="server">
         <table class="tablaInterna" cellpadding="1" cellspacing="5">
            <tr>
             ...
             <tr>
             <td><asp:Label ID="lblAlumnos" runat="server" Text="Alumno(s):" CssClass="lblAlumnos"></asp:Label></td>
             <td>
