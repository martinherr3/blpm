    ...
    public partial class ContenidoEncuestas : EDUARBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    if (encuestaSesion != null && encuestaSesion.idEncuesta > 0)
                    {
                        CargarPresentacion();
        ...
        protected void btnVolver_Click(object sender, EventArgs e)
        {
            try
            {
                if (AccionPagina == enumAcciones.Modificar || AccionPagina == enumAcciones.Nuevo)
                {
                    CargarPresentacion();
                    BuscarPregunta(encuestaSesion, null);
        ...
        private void CargarValoresEnPantalla(int idEntidad)
        {
            ...
            txtPesoPreguntaEdit.Text = pregunta.ponderacion.ToString().PadRight(3, '0');
        }
