...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <div id="divIndicador" runat="server" class="DivIndicador">
            <table border="0" cellpadding="2" cellspacing="0" width="162px">
                <tr>
                    <td rowspan="2" valign="top" style="width: 106px; height: 161px;">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="height:40px; vertical-align:middle;">
                                    <asp:Label ID="lblTitulo" runat="server" Font-Underline="true" Text="-"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" style="height:101px;">
                    ...
                    <td style="width: 56px; height: 79px; border-left: solid 1px #341010;vertical-align:top;">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center">
                ...
                <tr>
                    <td style="width: 56px; height: 79px; border-left: solid 1px #341010; border-top: solid 1px #341010;vertical-align:top;">
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center">
