...
{
	public class BLImportarAlumnos : BLProcesoBase
	{
		#region --[Atributos]--
		...
		public BLImportarAlumnos(String connectionString)
		...
		public void ImportarAlumnos()
		{
			try
			{
				...
				ProcesosEjecutadosCreate(enumProcesosAutomaticos.ImportarAlumnos.GetHashCode(), true);
			}
			catch (Exception ex)
			{
				...
				OnErrorProcess(enumProcesosAutomaticos.ImportarAlumnos.GetHashCode(), ex);
				throw ex;
			}
		}
		#endregion
