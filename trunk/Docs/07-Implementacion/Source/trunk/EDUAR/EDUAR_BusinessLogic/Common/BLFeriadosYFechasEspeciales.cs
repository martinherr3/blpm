    ...
    public class BLFeriadosYFechasEspeciales : BusinessLogicBase<FeriadosYFechasEspeciales, DAFeriadosYFechasEspeciales>
    {
        ...
        public override void Save()
        {
            try
            {
                ...
                if (Data.idFeriadosYFechasEspeciales == 0)
        ...
        //public List<FeriadosYFechasEspeciales> GetFeriadosYFechasEspecialess(FeriadosYFechasEspeciales entidad)
        //{
        //    try
        //    {
        //        return DataAcces.GetFeriadosYFechasEspecialess(entidad);
        //    }
        //    catch (CustomizedException ex)
        //    {
        //        throw ex;
