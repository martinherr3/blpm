...
{
	public class BLBajausuarios : BLProcesoBase
	{
		#region --[Atributos]--
        ...
        public BLBajausuarios(String connectionString)
		...
		/// Importars the datos.
		/// </summary>
		private void EfectuarBajaUsuarios()
		{
			...
			try
			{
				...
				SqlConnection conexion = new SqlConnection() { ConnectionString = ConnectionString };
				{
					...
					objDAImportarDatos = new DAImportarDatos(objConfiguracion.valor);
                    ...
                    objDAImportarDatos.EfectuarBajaUsuarios(transaccion);
				}
