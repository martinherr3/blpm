	...
	public partial class reportIndicadores : EDUARBasePage
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				criterioCalificacion.CriterioScroll += (ActualizarDistribucion);
				criterioInasistencia.CriterioScroll += (ActualizarDistribucion);
				criterioSancion.CriterioScroll += (ActualizarDistribucion);
		...
		/// <summary>
		/// Actualizars the distribucion.
		/// </summary>
		/// <param name="sender">The sender.</param>
		/// <param name="e">The <see cref="System.EventArgs"/> instance containing the event data.</param>
		protected void ActualizarDistribucion(object sender, EventArgs e)
		{
			try
			{
				GraficarDistribucion();
