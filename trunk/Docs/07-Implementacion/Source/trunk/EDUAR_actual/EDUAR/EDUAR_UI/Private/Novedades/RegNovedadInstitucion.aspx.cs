    ...
    public partial class RegNovedadInstitucion : EDUARBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                txtHoraEdit.validationSummary = "validarEdit";
                if (!Page.IsPostBack)
                {
                    CargarPresentacion();
                    BuscarEventos(null);
        ...
        {
            calFechaEdit.EtiquetaDesde = "Fecha";
            calFechaEdit.ValidarRangoDesde(false);
            calFechaEdit.EtiquetaDesde = "";
            ...
            else
            {
                ...
                Match m = r.Match(txtHoraEdit.Text.Trim());
                mensaje += m.Success ? string.Empty : "- Fecha<br />";
            }
