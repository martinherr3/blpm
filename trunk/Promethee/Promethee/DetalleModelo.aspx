...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="gvwModelo" runat="server" CssClass="DatosLista" SkinID="gridviewSkinPagerListado"
        ...
        CellPadding="5" CellSpacing="1" AutoGenerateEditButton="True" AutoGenerateDeleteButton="true"
        OnRowCancelingEdit="gvwModelo_RowCancelingEdit" OnRowEditing="gvwModelo_RowEditing"
        OnRowUpdating="gvwModelo_RowUpdating" 
        OnRowDeleting="gvwModelo_RowDeleting" 
        onpageindexchanging="gvwModelo_PageIndexChanging">
    ...
    <asp:GridView ID="gvwCriterios" runat="server" CssClass="DatosLista" SkinID="gridviewSkinPagerListado"
        ...
        onpageindexchanging="gvwCriterios_PageIndexChanging">
        <Columns>
            <asp:TemplateField HeaderText="Acciones">
                ...
                <ItemTemplate>
                    <asp:ImageButton ID="editCriterio" runat="server" CommandName="editCriterio" CommandArgument='<%# Bind("idCriterio") %>'
                        ToolTip="Editar Criterio" ImageUrl="~/Images/Grillas/edit_Criteria.png" />
                    <asp:ImageButton ID="btnEliminar" runat="server" CommandName="eliminar" CommandArgument='<%# Bind("idCriterio") %>'
